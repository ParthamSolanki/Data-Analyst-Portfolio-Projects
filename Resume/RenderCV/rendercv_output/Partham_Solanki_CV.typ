...
#let connections-list = (
  ...
  [#box(original-link("https://github.com/ParthamSolanki")[#fa-icon("github", size: 0.9em) #h(0.05cm)ParthamSolanki])],
)
...
#one-col-entry(
  content: [#strong[Data Analysis & BI:] SQL \(BigQuery, MySQL\), Python \(Pandas, NumPy, Matplotlib, Jupyter\), Excel \(Advanced\), R \(Rstudio, ggplot2\), Tableau, Power BI]
)
#v(design-entries-vertical-space-between-entries)
#one-col-entry(
  content: [#strong[Dev & Collaboration Tools:] Git \(Github, GitLab\), Linux \(Shell scripting\)]
)
#v(design-entries-vertical-space-between-entries)
#one-col-entry(
  content: [#strong[Cloud & Automation Tools:] Azure \(Data Studio, Synapse, Storage\), AWS \(S3, Redshift, Lambda\), GCP - Data storage and pipelines]
)
...
#block(
  [
    #set par(spacing: 0pt)
    #v(design-highlights-top-margin);#highlights([Electives: Finance],)
  ],
  inset: (
    left: design-entries-left-and-right-margin,
    right: design-entries-left-and-right-margin,
...
#emph[B. Ed. in Physical Science & Mathematics]
  ],
  right-content: [
    #emph[2023 – 2025]
  ],
